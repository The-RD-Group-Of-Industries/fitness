...
const TabTwoScreen: React.FC = () => {
  ...
  const handleAddPhone = async () => {
    ...
    if (value.length < 10) {
      Alert.alert("Invalid Phone Number", "Please enter a valid number (at least 10 digits).");
      return;
    }
    try {
      ...
      if (req.status === 200) {
        ...
        // Tip: In a real app, you might want to refresh the 'user' context here
      }
    } catch (error) {
        ...
        <View style={styles.container}>
          ...
          >
            <View style={styles.modalBackdrop}>
              <View style={styles.modalCard}>
                ...
                <Text style={styles.modalSubtitle}>Enter your mobile number below</Text>
                ...
                <View style={styles.modalButtons}>
                  <TouchableOpacity style={[styles.btn, styles.btnCancel]} onPress={() => setChangeNumber(false)}>
                    <Text style={styles.btnText}>Cancel</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={[styles.btn, styles.btnSave]} onPress={handleAddPhone}>
          ...
          <View style={styles.childContainer}>
            ...
            <View style={styles.cardPrimary}>
              <LinearGradient colors={["#704CC5", "#465EC2"]} style={styles.modCircle}>
                {user?.image ? (
...
const styles = StyleSheet.create({
  ...
  container: { width: "100%", minHeight: SCREEN_HEIGHT, alignItems: "center", justifyContent: "flex-start", paddingTop: hp(2) },
  ...
  cardPrimary: { width: isTablet() ? wp(80) : wp(92), backgroundColor: primary, borderRadius: normalize(16), padding: normalize(14), flexDirection: "row", alignItems: "center", marginBottom: hp(3), elevation: 8, minHeight: hp(18) },
  modCircle: { width: normalize(70), height: normalize(70), borderRadius: normalize(35), justifyContent: "center", alignItems: "center", overflow: "hidden" },
  ...
  smallCard: { width: isTablet() ? wp(80) : wp(92), backgroundColor: primary, borderRadius: normalize(16), padding: normalize(18), flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: hp(2.5), elevation: 5, minHeight: hp(9) },
